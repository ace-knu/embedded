...
Libraries/iLLD/TC27D/Tricore/_PinMap/%.src: ../Libraries/iLLD/TC27D/Tricore/_PinMap/%.c Libraries/iLLD/TC27D/Tricore/_PinMap/subdir.mk
	...
	cctc -D__CPU__=tc27xd "-fC:/Users/junho/AURIX-v1.5.4-workspace/tc275_PWM/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc27xd -o "$@"  "$<"  -cs --dep-file="$(@:.src=.d)" --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
