...
void init_GTM_TOM0_PWM(void)
{
    ...
    GTM_TOM0_TGC1_GLB_CTRL |= ((0x2) << UPEN_CTRL3);    // TOM0 channel 11 enable update of
                                                        // register CM0, CM1, CLK_SRC

    GTM_TOM0_TGC1_FUPD_CTRL |= ((0x2) << FUPD_CTRL3);   // Enable force update of TOM0 channel 11
    GTM_TOM0_TGC1_FUPD_CTRL |= ((0x2) << RSTCN0_CH3);   // Reset CN0 of TOM0 channel 11 on force update

    GTM_TOM0_TGC1_ENDIS_CTRL |= ((0x2) << ENDIS_CTRL3); // Enable channel 11 on an update trigger
    GTM_TOM0_TGC1_OUTEN_CTRL |= ((0x2) << OUTEN_CTRL3); // Enable channel 11 output on an update trigger
